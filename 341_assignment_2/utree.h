...
public:
  ...
  void addNewNode(UNode* node, Account newAcct);
...
private:
  ...
  void recursiveCheckImbalance(UNode* node);
  UNode* removeUNode(UNode* node);
  UNode* findParentLargestNode(UNode* node);
  void findParentEmptyUNode(UNode* node);
};
